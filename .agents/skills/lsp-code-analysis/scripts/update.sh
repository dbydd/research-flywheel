...
# ponytail: lsp-cli 0.4.0 currently imports a missing lsap.capability.doc; unpin when upstream fixes it.
LSP_CLI_SPEC=${LSP_CLI_SPEC:-lsp-cli==0.3.3}
uv tool install --python 3.13 --with lsap-sdk==0.1.5 "$LSP_CLI_SPEC"

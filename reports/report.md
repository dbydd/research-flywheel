# Report — 20260903-smoke-verify1

## Hypothesis
Two-stage fitting — coarse slope then bias correction — separates scale and offset error.
...
## Evidence
- traces/20260903-smoke-verify1/metrics.json
- traces/20260903-smoke-verify1/verification.json
- traces/20260903-smoke-verify1/raw-result.json
## Success language
